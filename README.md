...
- [ ] Explain what a token is used for.
  ...
  A token is a unique string used to authenticate a user by sending it as the payload for requests

- [ ] What steps can you take in your web apps to keep your data secure?

      storing user information in hashtables, authenticating user sessions

- [ ] Describe how web servers work.

      a server listens for incoming requests and then runs the functions associated with those requests. Serving back any data needed to the client.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      get- to retrieve data
      push- to add new data to a database
      put - to update an existing data entry
      delete- to ........well delete data
